...
const Sidebar = ({ open, setOpen, userRole }) => {
  ...
  const getNavigationItems = () => {
    // Normalize role: ensure first letter is uppercase, rest lowercase to match switch cases
    const normalizedRole = userRole ? userRole.charAt(0).toUpperCase() + userRole.slice(1).toLowerCase() : "";
