    ...
    const handleSubmit = (e) => {
        ...
        dispatch(register(formData)).then((res) => {
            if (res.meta.requestStatus === 'fulfilled') {
                navigate('/login'); // Redirect to login after successful registration (or dashboard if auto-login)
            }
        });
    };
                ...
                <div className="relative z-10">
                    ...
                    <div className="space-y-6 max-w-lg mt-20">
                        <h1 className="text-5xl font-extrabold tracking-tight leading-tight">
                            Join the <span className="text-blue-400">future</span> of project management.
                        </h1>
                        <p className="text-lg text-slate-400">
                            Create your account to start managing projects, submitting proposals, and collaborating with your team today.
                        </p>
                    </div>
                </div>
            ...
            <div className="flex-1 flex items-center justify-center p-6 lg:p-12 relative">
                <div className="w-full max-w-md space-y-8 animate-fade-in">
                    ...
                    <div className="bg-slate-100 p-1 rounded-xl flex">
                        {['student', 'teacher', 'admin'].map((r) => (
                            <button
                                ...
                                className={`flex-1 py-2 text-sm font-semibold rounded-lg capitalize transition-all duration-200 ${formData.role === r
                    ...
                    <div className="text-center">
                        <Link to="/login" className="font-semibold text-slate-700 hover:text-blue-600 transition-colors">
                            Sign in here
                        </Link>
                    </div>
                </div>
